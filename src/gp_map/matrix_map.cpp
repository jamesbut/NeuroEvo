...
Phenotype* MatrixMap::map(Genotype& genotype, PhenotypeSpec& pheno_spec) {

    const Matrix<double> genes(genotype.get_genes());
    ...
    FixedNetworkSpec* net_spec = dynamic_cast<FixedNetworkSpec*>(&pheno_spec);
